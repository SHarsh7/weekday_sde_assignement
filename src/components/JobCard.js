    ...
    <Card sx={{ borderRadius: 8 }} elevation={3}>
      <CardContent
        ...
        {minExp && maxExp ? (
          ...
          <Typography variant='subtitle1'>Experience: Not mentioned</Typography>
        )}
        ...
        <div style={{ marginTop: 10, width: "100%" }}>
          <Button
            style={{ backgroundColor: "#4C46DA", color: "white" }}
            href={jdLink}
            target='_blank'
            fullWidth
            variant='contained'
        ...
        <Dialog open={expanded} onClose={() => setExpanded(false)}>
          ...
          <DialogContent>
            ...
            {minExp && maxExp ? (
              ...
              <Typography variant='body2'>Experience: Not mentioned</Typography>
            )}
